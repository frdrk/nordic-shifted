...
gulp.task('styles', function(done) {
    gulp.src('gtk-3.0/**/*.scss')
        ...
        .pipe(exec(' gsettings set org.gnome.desktop.interface gtk-theme "NordicShift"'))
    done();
});
...
gulp.task('shell-style', function(done) {
    gulp.src('gnome-shell/**/*.scss')
        ...
        .pipe(exec('gsettings set org.gnome.shell.extensions.user-theme name "NordicShift"'))
    done();
});
